...
const PersonalList = ({ personal, usuario, onPersonalAgregado, servicios = [] }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-colors duration-300">
      <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 dark:from-indigo-700 dark:to-indigo-800 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <h2 className="text-xl font-bold text-white">Personal</h2>
          {usuario?.rol === 'administrador' && (
            <button
              onClick={() => setMostrarForm(!mostrarForm)}
              className="p-2 bg-white text-indigo-600 rounded-lg hover:bg-indigo-50 transition shadow-md hover:shadow-lg w-full sm:w-auto"
            >
            ...
            {personal.map((persona) => {
              ...
              return (
                <div
                  ...
                  className="group flex flex-col sm:flex-row sm:items-center gap-4 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-indigo-300 dark:hover:border-indigo-600 hover:shadow-md transition-all duration-200 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700"
                >
